...
import img8 from "../Images/ChatGPT Image Sep 25, 2025, 10_28_27 AM.png"
...
const Contact = () => {
    ...
    return (
        <section className="min-h-screen contact flex justify-center flex-col items-center">
            <div className="h-full mt-[12em] w-full rounded flex flex-col gap-12 sm:gap-6 p-20 lg:flex-row justify-center items-center ">
                <div className="w-full relative z-10 h-full flex flex-col justify-center items-center">
                  <form className="w-full p-20 h-full sm:px-32 lg:px-2 flex flex-col justify-center items-center gap-6 ">
                        ...
                        <div>
                            <button type="submit" className="btn transition bg-black hover:bg-black/40 text-white px-3 py-2 text-lg rounded-md">
                                Send Message
                            </button>
                        </div>
                ...
                <div className="w-full h-full flex justify-center items-center">
                    {/*<img src={img8} alt="The plumber"  className="w-[32em] h-[32em] rounded-full"/>*/}
                </div>
            </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                        ...
                        <p className="text-xl">fatawuabass@gmail.com</p>
                    </div>
                    <div className="rounded-md w-[16em] flex flex-col justify-center items-center p-6 h-[10em] bg-[#F5DEB3]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
