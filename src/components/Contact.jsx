...
const Contact = () => {
    ...
    return (
        <section id="contact" className="overflow-x-hidden min-h-screen p-12 contact flex justify-center flex-col items-center">
            <p className="text-md opacity-0 translate-y-[122px] contactHeading bg-gray-200 rounded-full my-16 px-4 py-2">Contact us</p>
            ...
            <div className="w-full px-6 flex justify-center items-center">
                ...
                <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-x-6 gap-y-12 ">
                    <div className="contactDetail opacity-0 translate-y-[122px] rounded-md flex flex-col justify-center items-center p-6 w-[16e7] h-[10em] bg-[#F5DEB3]">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                    ...
                    <div className="contactDetail opacity-0 translate-y-[122px] rounded-md w-[18em] flex flex-col justify-center items-center p-6 h-[10em] bg-[#F5DEB3]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                    ...
                    <div className="rounded-md contactDetail opacity-0 translate-y-[122px] w-[18em] flex flex-col justify-center items-center p-6 h-[10em] bg-[#F5DEB3]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
</svg>

                        <p className="text-xl m-4">fatawuabass@gmail.com</p>
                    </div>
                    <div className="contactDetail opacity-0 translate-y-[122px] rounded-md w-[18em] flex flex-col justify-center items-center p-6 h-[10em] bg-[#F5DEB3]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
