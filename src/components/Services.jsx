...
const Services = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center py-20 px-6 md:px-14">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-20 p-6">
        <div className="service flex rounded justify-center w-[20em] lg:w-[16em] md:w-[16em] shadow-lg hover:shadow-xl transition items-center bg-[#F5DEB3] flex-col">
